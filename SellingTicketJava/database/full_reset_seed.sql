...
-- =============================================
-- SEED DATA — USERS (25 users)
-- Mật khẩu BCrypt:
--   admin / support agent  → Admin@123
...
-- 6: Organizer — TechViet Community
('hello@techviet.org',
 '$2a$12$Bs2nPLu8UK8GZsy1flBiGewDcqwu4x/KqtksjeYEWRQtcBxgiyNVC',
...
-- 7: Organizer — Saigon Sports Club
...
-- 8: Organizer — Sunset Entertainment (NEW)
...
-- ========= CUSTOMERS (15) =========
-- 9: Customer — Nguyễn Văn An (VIP — total spend > 5M, many orders)
...
-- 10: Customer — Trần Thị Bình (moderate spend, Gold tier)
('binh.tran@gmail.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 11: Customer — Lê Hoàng Cường (has cancelled orders)
('cuong.le@yahoo.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 12: Customer — Phạm Minh Đức (active buyer, has free ticket orders)
...
-- 13: Customer — Vũ Thị Hà (female, moderate, diverse events)
('ha.vu@gmail.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 14: Customer — Đỗ Quang Khải (tech-focused buyer)
('khai.do@gmail.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 15: Customer — Ngô Thanh Tùng (low-spend tier — New)
('tung.ngo@gmail.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 16: Customer — Hoàng Thị Yến (unverified email — edge case)
('yen.hoang@yahoo.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 17: Customer — Bùi Quốc Bảo (regular buyer, voucher user)
('bao.bui@gmail.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 18: Customer — Lý Minh Châu (refund scenario customer)
('chau.ly@gmail.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 19: Customer — Trịnh Hoàng Long (new user, no orders yet)
...
-- 20: Customer — Phan Ngọc Diễm (active, multiple events)
('diem.phan@gmail.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- 21: Customer — Đặng Trung Kiên (checked-in scenario)
('kien.dang@gmail.com',
 '$2a$12$07H.CL1nHx2kzH7oo1odGOClkIg/oK3s7.D/wxcRIL6xjhIo9sYhK',
...
-- =============================================
-- SEED DATA — 30 EVENTS
-- organizer_id: 4=Live Nation, 5=Vietravel, 6=TechViet, 7=Saigon Sports, 8=Sunset
-- STATUS distribution: approved=18, pending=4, rejected=3, draft=3, cancelled=1, completed(ended)=1
-- =============================================
...
-- E3: approved, featured, nearly sold out
(4, 1,
...
-- E6: approved, by Sunset Entertainment
(8, 1,
...
-- E12: approved, past event (completed)
(7, 2,
...
-- Update pre_order for pending events
...
-- =============================================
-- SEED DATA — TICKET TYPES (2-4 loại mỗi approved event = 65+ ticket types)
-- =============================================
...
-- =============================================
-- SEED DATA — 35 ORDERS (diverse statuses & scenarios)
-- Status: paid=25, pending=3, cancelled=4, refunded=3
-- Covers: VIP spend, multi-item, free tickets, voucher, refund
-- =============================================
DECLARE @now DATETIME = GETDATE();

-- === CUSTOMER 9 (An) — VIP buyer: 6 paid orders, 1 pending = ~15.5M total ===
-- O1: E1 (Hà Anh Tuấn) — 2 VIP Gold + 1 CAT1
...
-- O2: E3 (Sơn Tùng) — 2 Gold Standing
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O4: E14 (Data Science) — 1 Full Bootcamp
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O5: E26 (AI Summit) — 1 Student/Startup
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O11: E20 (Triển lãm) — 2 Workshop Pass + VOUCHER discount
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O14: E10 (Night Run) — 2 Runner — paid
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O16: E27 (Hackathon) — free team ticket
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O19: E20 (Triển lãm) — 1 Workshop Pass
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O21: E13 (UI/UX Workshop) — 1 Standard
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O23: E17 (Ẩm thực) — 1 Vé ngày thường
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O24: E6 (Indie Sunset) — 2 VIP Beach Lounge
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O28: E17 (Ẩm thực) — paid (after refund, still buys)
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O30: E16 (Digital Marketing) — Full 5 Days
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O31: E12 (Saigon Fun Run 2025 — past) — 1 VIP Runner — checked in
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- === EDGE CASE ORDERS ===
-- O33: CUSTOMER 11 — CANCELLED (2nd cancel to test pattern)
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O34: CUSTOMER 25 (Phúc) — 1 SVIP HAT (big spend from full-profile user)
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- O35: CUSTOMER 18 — REFUNDED (3rd refund — to test refund report)
INSERT INTO Orders (order_code, user_id, event_id, total_amount, discount_amount, final_amount, status, payment_method, payment_date, buyer_name, buyer_email, buyer_phone, created_at)
...
-- =============================================
-- SEED DATA — TICKETS (from paid orders only)
-- =============================================
...
-- =============================================
-- SEED DATA — PAYMENT TRANSACTIONS (tất cả paid + pending + cancelled)
-- =============================================
...
-- =============================================
-- SEED DATA — VOUCHER USAGES (link voucher to order)
-- =============================================
...
-- Fix voucher usage discount: SUNSET10 = 10% * 2400000 = 240000, but O24 discount was 360000.
-- Let's correct O24 discount to match LIVENATION15 instead (15% * 2400000 = 360000)
...
-- =============================================
-- SEED DATA — SUPPORT TICKETS (10 tickets, all statuses, all categories)
-- =============================================
...
-- ST1: resolved (fast response demo)
...
-- ST3: in_progress (cancellation/refund)
...
-- ST9: resolved (organizer — event question)
...
-- ST10: open (refund request — urgent)
...
-- ST7 conversation (in progress — account)
...
-- ST8 conversation (open — missing ticket)
...
-- =============================================
-- SEED DATA — MEDIA (sample Cloudinary references)
-- =============================================
...
-- User avatars (manually uploaded)
