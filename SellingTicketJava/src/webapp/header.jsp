                        ...
                        <c:when test="${sessionScope.account != null}">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end glass-strong border-0 rounded-4 p-2 mt-2 shadow">
                                    <li><a class="dropdown-item rounded-3 py-2" href="${pageContext.request.contextPath}/profile"><i class="fas fa-user me-2 text-primary"></i><span data-i18n="nav.profile">Hồ sơ</span></a></li>
                                    <li><a class="dropdown-item rounded-3 py-2" href="${pageContext.request.contextPath}/my-tickets"><i class="fas fa-ticket-alt me-2 text-primary"></i><span data-i18n="nav.my_tickets">Vé của tôi</span></a></li>
                                    <li><a class="dropdown-item rounded-3 py-2" href="${pageContext.request.contextPath}/organizer/events"><i class="fas fa-calendar-check me-2 text-primary"></i><span data-i18n="nav.my_events">Sự kiện của tôi</span></a></li>
