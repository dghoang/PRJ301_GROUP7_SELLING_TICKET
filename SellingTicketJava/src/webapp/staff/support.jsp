    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <div class="d-flex gap-2 mb-4 flex-wrap animate-on-scroll">
                <a href="${pageContext.request.contextPath}/staff/support" class="btn ${empty statusFilter ? 'btn-primary' : 'glass'} rounded-pill px-3 py-1 small">Tất cả</a>
                <a href="${pageContext.request.contextPath}/staff/support?status=open" class="btn ${statusFilter == 'open' ? 'btn-warning' : 'glass'} rounded-pill px-3 py-1 small">
                    Mở <span class="badge bg-white bg-opacity-25 ms-1">${openCount}</span>
                </a>
                <a href="${pageContext.request.contextPath}/staff/support?status=in_progress" class="btn ${statusFilter == 'in_progress' ? 'btn-info' : 'glass'} rounded-pill px-3 py-1 small">Đang xử lý</a>
                <a href="${pageContext.request.contextPath}/staff/support?status=resolved" class="btn ${statusFilter == 'resolved' ? 'btn-success' : 'glass'} rounded-pill px-3 py-1 small">Đã giải quyết</a>
                <a href="${pageContext.request.contextPath}/staff/support?status=closed" class="btn ${statusFilter == 'closed' ? 'btn-secondary' : 'glass'} rounded-pill px-3 py-1 small">Đã đóng</a>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="pe-4 text-end">
                                        <a href="${pageContext.request.contextPath}/staff/support/${t.ticketId}" class="btn btn-sm glass rounded-pill px-3">
