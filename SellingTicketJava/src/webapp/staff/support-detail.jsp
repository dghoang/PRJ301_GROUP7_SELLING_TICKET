        ...
        <div class="col-lg-10">
            ...
            <nav aria-label="breadcrumb" class="mb-4 animate-fadeInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/staff/support" class="text-decoration-none">Hỗ trợ</a></li>
                    ...
                    <div class="card glass-strong border-0 rounded-4 animate-on-scroll">
                        ...
                        <div class="card-body px-4 pb-4">
                            ...
                            <c:if test="${ticket.status != 'closed'}">
                                <form method="POST" action="${pageContext.request.contextPath}/staff/support/reply" class="mt-4 pt-3 border-top">
                    ...
                    <div class="card glass-strong border-0 rounded-4 mb-4 animate-on-scroll stagger-1">
                        <div class="card-body p-4">
                            ...
                            <c:if test="${empty ticket.assignedTo || ticket.assignedTo != sessionScope.user.userId}">
                                <form method="POST" action="${pageContext.request.contextPath}/staff/support/assign" class="mb-2">
                                    <input type="hidden" name="csrf_token" value="${sessionScope.csrf_token}">
                                    <input type="hidden" name="ticketId" value="${ticket.ticketId}">
                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/staff/support/status" class="mb-2">
                                <input type="hidden" name="csrf_token" value="${sessionScope.csrf_token}">
                                <input type="hidden" name="ticketId" value="${ticket.ticketId}">
                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/staff/support/priority">
                                <input type="hidden" name="csrf_token" value="${sessionScope.csrf_token}">
                                <input type="hidden" name="ticketId" value="${ticket.ticketId}">
