...
<div class="container py-5" style="max-width: 1140px;">
    ...
    <div class="mb-5 animate-fadeInUp">
        <a href="${pageContext.request.contextPath}/event?id=${param.eventId}" class="d-inline-flex align-items-center gap-2 text-muted text-decoration-none mb-3 hover-lift">
