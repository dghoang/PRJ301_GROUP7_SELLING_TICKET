 ...
 */
@WebServlet(name = "StaffSupportTicketController", urlPatterns = {"/staff/support", "/staff/support/*"})
public class StaffSupportTicketController extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(StaffSupportTicketController.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (admin == null || (!"support_agent".equals(admin.getRole()) && !"admin".equals(admin.getRole()))) {
            ...
            if (path != null && path.matches("/\\d+")) {
                ...
                request.getRequestDispatcher("/staff/support.jsp").forward(request, response);
            }
        } catch (Exception e) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/staff/support/" + ticketId);
    }
}
