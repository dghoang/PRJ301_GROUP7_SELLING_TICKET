...
<div class="container py-5" style="max-width: 1140px;">
    ...
    <div class="mb-5 animate-fadeInUp">
        ...
        <p class="text-muted lead"><c:out value="${event.title}" default="Chọn vé sự kiện" /></p>
    </div>

    <%-- Event ended / error message --%>
    ...
    <c:if test="${isPreOrder}">
        <div class="alert border-0 rounded-4 mb-4" style="background: rgba(245,158,11,0.08); border-left: 4px solid #f59e0b !important;">
            <div class="d-flex align-items-center gap-2">
                <i class="fas fa-clock text-warning fs-5"></i>
                <div>
                    <strong style="color: #d97706;">Chế độ đặt trước</strong>
                    <p class="text-muted small mb-0">Vé chưa chính thức mở bán. Bạn có thể đặt trước, vé sẽ được xác nhận khi mở bán.</p>
                </div>
            </div>
        </div>
    </c:if>
