        ...
        <div class="col-lg-10">
            ...
            <form id="createEventForm" action="${pageContext.request.contextPath}/organizer/create-event" method="POST" enctype="multipart/form-data">
                ...
                <div class="wizard-panel active" data-panel="1">
                    <!-- Tips Banner -->
                    <div class="alert border-0 rounded-4 mb-4" style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.08), rgba(6, 182, 212, 0.08)); border-left: 4px solid #10b981 !important;">
                        <div class="d-flex align-items-start gap-3">
                            <div class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" style="width: 40px; height: 40px; background: linear-gradient(135deg, #10b981, #06b6d4);">
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card glass-strong border-0 rounded-4 animate-on-scroll visible">
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="desc-editor" contenteditable="true" id="descEditor" spellcheck="false" placeholder="Mô tả chi tiết về sự kiện, chương trình, nghệ sĩ..."></div>
                        ...
                        <div class="col-lg-5">
                            ...
                            <hr class="my-3">
                            <h6 class="fw-bold mb-3"><i class="fas fa-cog text-muted me-2"></i>Tùy chọn hiển thị</h6>
                            <div class="row g-3">
                                <div class="col-6">
                                    <div class="form-check form-switch">
                                        ...
                                        <br><small class="text-muted">Chỉ ai có link mới xem</small>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-check form-switch">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 d-flex align-items-center">
                                    <div class="form-check form-switch mt-3">
                                        <input class="form-check-input" type="checkbox" name="preOrderEnabled" value="true" id="preOrderSwitch"
                                               style="width: 2.5rem; height: 1.25rem; cursor: pointer;">
                                        <label class="form-check-label fw-medium" for="preOrderSwitch">Cho phép đặt trước</label>
...
function addTicketType() {
    var container = document.getElementById('ticketTypes');
...
function removeTicketType(btn) {
    var card = btn.closest('.ticket-type-card');
...
function updateRemoveButtons() {
    ...
    cards.forEach(function(c) {
        var btn = c.querySelector('.remove-ticket');
...
function updateTotal() {
    ...
    document.querySelectorAll('.ticket-type-card').forEach(function(card) {
        var price = parseInt(card.querySelector('.ticket-price') ? card.querySelector('.ticket-price').value : '0') || 0;
        var qty = parseInt(card.querySelector('.ticket-qty') ? card.querySelector('.ticket-qty').value : '0') || 0;
        totalQty += qty;
        totalRev += price * qty;
    });
...
function populateReview() {
    ...
    var tQty = 0, tRev = 0;
    document.querySelectorAll('.ticket-type-card').forEach(function(card) {
        var name = card.querySelector('[name="ticketName[]"]').value || '\u2014';
        var price = parseInt(card.querySelector('.ticket-price').value) || 0;
        var qty = parseInt(card.querySelector('.ticket-qty').value) || 0;
        var sub = price * qty;
        tQty += qty; tRev += sub;
        tbody.innerHTML += '<tr>' +
            '<td>' + name + '</td>' +
